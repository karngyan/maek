...
const colors = {
  ...
  primary:
    'bg-primary-400/20 text-primary-700 group-data-hover:bg-primary-400/30 dark:bg-primary-400/10 dark:text-primary-300 dark:group-data-hover:bg-primary-400/15',
