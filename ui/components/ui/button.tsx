...
const styles = {
  ...
  baseSquare: [
    // Base
    'relative isolate inline-flex items-center justify-center gap-x-2 rounded-sm border text-base/6 font-semibold',
    // Sizing
    'px-[calc(--spacing(2.5)-1px)] py-[calc(--spacing(2.5)-1px)] sm:px-[calc(--spacing(1.5)-1px)] sm:py-[calc(--spacing(1.5)-1px)] sm:text-sm/6',
    // Focus
    'focus:outline-hidden data-focus:outline data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-blue-500',
    // Disabled
    'data-disabled:opacity-50',
  ...
  colors: {
    'dark/zinc': [
      'text-zinc-400 [--btn-bg:var(--color-zinc-900)] [--btn-border:var(--color-zinc-950)]/90 [--btn-hover-overlay:var(--color-white)]/10',
