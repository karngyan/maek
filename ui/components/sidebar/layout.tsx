  ...
  return (
    <div className='relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950'>
      ...
      <main className={cn('transition-all duration-100 ease-in-out flex flex-1 max-h-svh flex-col pb-2 lg:min-w-0 lg:pr-2 lg:pt-2', isSidebarOpen ? 'lg:pl-64' : 'lg:pl-16')}>
        ...
        <div className='h-full overflow-scroll lg:rounded-lg lg:bg-white lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10'>
          {children}
        </div>
      </main>
      ...
      {isAnyRightSidebarOpen && (
        ...
        >
          <aside className='flex flex-1 h-full max-h-svh flex-col pb-2 lg:min-w-0 lg:pr-2 lg:pt-2'>
            ...
            <div className='h-full overflow-scroll lg:rounded-lg lg:bg-white lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10'></div>
          </aside>
        </Resizable>
      )}
    </div>
