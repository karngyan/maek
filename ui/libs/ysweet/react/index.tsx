// https://github.com/jamsocket/y-sweet/blob/main/js-pkg/react/src/main.tsx
// With minor modifications to allow setting an initialContentsUpdate
'use client'
...
export type YDocProviderProps = {
  ...
  /** An optional initial Y.Doc state to use. */
  initialContentsUpdate?: Uint8Array
...
export function YDocProvider(props: YDocProviderProps) {
  const { children, docId, authEndpoint, initialClientToken, initialContentsUpdate } = props
  ...
  useEffect(() => {
    ...
    if (initialContentsUpdate) {
      Y.applyUpdateV2(doc, initialContentsUpdate);
    }
